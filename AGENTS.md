...
6. `machine_profile.json` is a deployed copy of the external authoritative machine contract. Do not maintain an independent edited version in this repository.
